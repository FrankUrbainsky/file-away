...
jQuery(function($){
	...
	function ssfa_submit_shortcode() {
		...
		if ( stype === 'fileaway' && ttype === 'table' ) {
			var	options = { 'name' : '', 'base' : '', 'sub' : '', 'directories' : '', 'manager' : '', 'role_override' : '', 'user_override' : '', 'password' : '', 'images' : '', 'code' : '', 'only' : '', 'exclude' : '', 'include' : '', 'showto' : '', 'hidefrom' : '', 'heading' : '', 'hcolor' : '', 'width' : '', 'perpx' : '', 'align' : '', 'size' : '', 'mod' : '', 'recursive' : '', 'style' : '', 'search' : '', 'paginate' : '', 'pagesize' : '', 'textalign' : '', 'customdata' : '', 'sortfirst' : '', 'nolinks' : '', 'debug' : '' }; 
			for( var index in options) {
		...
		if ( stype === 'fileaframe') {
			var	options = { 'name' : '', 'src' : '', 'scroll' : '', 'height' : '', 'width' : '', 'mheight' : '', 'mwidth' : '' }; 
			for( var index in options) {
