...
jQuery(function($){
	...
	function ssfa_submit_shortcode() {
		...
		if ( stype === 'fileaway' && ttype !== 'table' ) {
			var	options = { 'base' : '', 'sub' : '', 'images' : '', 'code' : '', 'only' : '', 'exclude' : '', 'include' : '', 'heading' : '', 'hcolor' : '', 'width' : '', 'perpx' : '', 'align' : '', 'size' : '', 'mod' : '', 'style' : '', 'corners' : '', 'color' : '', 'accent' : '', 'icons' : '', 'iconcolor' : '', 'display' : '', 'debug' : '' }; 
		...
		if ( stype === 'fileaway' && ttype === 'table' ) {
			var	options = { 'base' : '', 'sub' : '', 'images' : '', 'code' : '', 'only' : '', 'exclude' : '', 'include' : '', 'heading' : '', 'hcolor' : '', 'width' : '', 'perpx' : '', 'align' : '', 'size' : '', 'mod' : '', 'style' : '', 'search' : '', 'paginate' : '', 'pagesize' : '', 'textalign' : '', 'customdata' : '', 'sortfirst' : '', 'debug' : '' }; 
			for( var index in options) {
		...
		if ( stype === 'attachaway' && ttype !== 'table' ) {
			var	options = { 'postid' : '', 'images' : '', 'code' : '', 'only' : '', 'exclude' : '', 'include' : '', 'heading' : '', 'hcolor' : '', 'width' : '', 'perpx' : '', 'align' : '', 'size' : '', 'style' : '', 'corners' : '', 'color' : '', 'accent' : '', 'icons' : '', 'iconcolor' : '', 'display' : '', 'debug' : '' }; 
			for( var index in options) {
		...
		if ( stype === 'attachaway' && ttype === 'table' ) {
			var	options = { 'postid' : '', 'images' : '', 'code' : '', 'only' : '', 'exclude' : '', 'include' : '', 'heading' : '', 'hcolor' : '', 'width' : '', 'perpx' : '', 'align' : '', 'size' : '', 'style' : '', 'search' : '', 'paginate' : '', 'pagesize' : '', 'textalign' : '', 'capcolumn' : '', 'descolumn' : '', 'sortfirst' : '', 'debug' : '' }; 
			for( var index in options) {
		...
		jQuery('#ssaa-banner,\
			...
			#ssfa-attachaway-list-toggle,\
			#ssfa-attachaway-table-toggle').css({opacity : '0', 'z-index' : '-1'});
