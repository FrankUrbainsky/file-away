...
jQuery(function($){
	...
	function ssfa_submit_shortcode() {
		...
		if ( stype === 'fileaway' && ttype === 'table' ) {
			var	options = { 'base' : '', 'sub' : '', 'images' : '', 'code' : '', 'only' : '', 'exclude' : '', 'include' : '', 'heading' : '', 'hcolor' : '', 'width' : '', 'perpx' : '', 'align' : '', 'size' : '', 'mod' : '', 'style' : '', 'search' : '', 'paginate' : '', 'pagesize' : '', 'textalign' : '', 'customdata' : '', 'debug' : '' }; 
			for( var index in options) {
		...
		if ( stype === 'attachaway' && ttype === 'table' ) {
			var	options = { 'postid' : '', 'images' : '', 'code' : '', 'only' : '', 'exclude' : '', 'include' : '', 'heading' : '', 'hcolor' : '', 'width' : '', 'perpx' : '', 'align' : '', 'size' : '', 'style' : '', 'search' : '', 'paginate' : '', 'pagesize' : '', 'textalign' : '', 'capcolumn' : '', 'descolumn' : '', 'debug' : '' }; 
			for( var index in options) {
