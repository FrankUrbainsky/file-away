...
if (!empty($ssfa_customcss) && (!file_exists(css_path()))) {
	ssfa_create_css();
}

function css_path() {
	global $blog_id; $cssid = ( $blog_id > "1" ) ? $cssid = "_id-".$blog_id : $cssid = null;
	$css_path = SSFA_CUSTOM_CSS."ssfa-custom-styles".$cssid.".css";
	return $css_path;
}

function css_url() {
	global $blog_id; $cssid = ( $blog_id > "1" ) ? $cssid = "_id-".$blog_id : $cssid = null;
	$css_url = SSFA_CUSTOM_CSS_URL."ssfa-custom-styles".$cssid.".css";
	return $css_url;
}
