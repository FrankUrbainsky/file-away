...
jQuery(document).ready(function($) {
	...
	$('#ssfamodal-type, #ssfamodal-shortcode-type').bind('change', function(event){
		...
		$thumbops.fadeOut(1000); $manmodeops.fadeOut(1000); $dirtreeops.fadeOut(1000); $dirrecurseops.fadeOut(1000); $playbackops.fadeOut(1000); $listrecurse.fadeOut(1000);
...
To enable the generation of thumbnails in your table for jpg/jpeg, gif, and png images, enable this. For these image types, the file type icon will be replaced with a thumbnail image generated on the fly, if the source image falls within the criteria specified in the Image Source options that will appear below when this setting is enabled.
</div></div>
