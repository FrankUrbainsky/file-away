...
The maximum allowed file size for each individual uploaded file. Enter an integer (e.g., 20), and specify MB, KB, or GB from the dropdown. If left blank, the default will be 10MB. Note that the system will also check the post_max_size from your php.ini file, and if the post_max_size is smaller than the size you specify here, it will override your specification. 
</div></div>
