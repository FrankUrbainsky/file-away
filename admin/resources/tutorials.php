...
<td>table</td>
<td class="ssfa-minimalist-last-column">With the [fileaway] shortcode, you can add a custom column to your table and add custom data to any file you want. Name the column using the "customdata" attribute, e.g., <code>customdata="Artist"</code>, then to add data to your files, just put the data in between square brackets [ ] at the *end* of your file name, *before* the extension. Example filenames: 
<br />
<br />
...
<td>table</td>
<td class="ssfa-minimalist-last-column">Choose by which column to sort on initial page load, either ascending or descending. filename (ascending) is the default if the attribute is not used.</td>
</tr>';
