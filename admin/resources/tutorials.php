...
<td>true</td>
<td>table</td>
<td class="ssfa-minimalist-last-column">Defaults to false if omitted. To enable the generation of thumbnails in your table for jpg/jpeg, gif, and png images, set this to true. For these image types, the file type icon will be replaced with a thumbnail image generated on the fly, if the source image falls within the criteria specified in the maxsrcbytes, maxsrcwidth, and maxsrcheight attributes options below.</td>
</tr>';
echo '<tr>
<td class="ssfa-minimalist-first-column">[fileaway]</td>
<td>thumbstyle</td>
