...
echo "<div id='ssfa-help-direxclusions' class='ssfa-help-backdrop'>
		...
		A comma-separated list of directory names you wish to permanently exclude from all Directory Tree tables and from Manager Mode Bulk Action Destination generators. Do not include the forward slashes (\"/\") Example: 
		<br />
		<br />
