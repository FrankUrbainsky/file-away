...
Stable tag: 3.0
License: GPLv3
Tags: files, attachments, upload, ajax, shortcodes, lists, tables, directory, monetize, lightbox, audio, video, file manager, encryption, custom css, formidable, forms, dynamic
...
* Four shortcodes with over 100 optional attributes to fine-tune the appearance and functionality of your lists and tables and file upload forms.<br><br>
