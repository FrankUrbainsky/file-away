...
1. The File Away menu can be found below the Settings menu on the Admin panel. Begin by configuring your Base Directories.

2. Set permissions, enable/disable some options, choose where to enqueue the CSS and Javascript, etc.

3. Easily create your own custom CSS styles for your lists and tables, using File Away's Custom Styles helpers and the built-in CSS editor, or create your own stylesheet and File Away will enqueue it for you.

4. Here you can reset all your settings to their defaults (be careful with this!), or choose whether to preserve or delete your settings when you uninstall the plugin.

5. A host of extensive tutorials for your reference.

6. The obligatory About page. Nothing to see here.

7. Info links on almost every setting field open up a modal window to give you a clear and detailed understanding of File Away's functionality.

8. The shortcode button on the TinyMCE Panel.

9. The shortcode generator opens up. Begin by selecting your shortcode and the type of display you want.
