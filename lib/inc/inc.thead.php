...
if($type === 'table')
{
	...
	$thefiles .= "<script type='text/javascript'>jQuery(function(){ jQuery('.footable').footable();});</script>".
		"<table id='ssfa-table-$uid' data-filter='#filter-$uid' $disablesort $page class='footable ssfa-sortable $theme $textalign $treeclass $bulkclass' $data_drawer $data_atts $data_stat>".
			"<thead><tr>".
