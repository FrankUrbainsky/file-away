...
if($type === 'table')
{
	...
	$data_atts = $manager ? 'data-uid="'.$uid.'" data-pg="'.$GLOBALS['post']->ID.'" data-drw="'.$drawericon.'" data-cls="'.$style.'" '.
	...
	$thefiles .= 
		...
		"<table id='ssfa-table-$uid' data-filter='#filter-$uid' $page class='footable ssfa-sortable $style $textalign $bulkclass' $data_atts><thead><tr>".
