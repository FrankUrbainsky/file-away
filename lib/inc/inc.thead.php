...
if($type === 'table')
{
	...
	$thefiles .= 
		...
		"<table id='ssfa-table-$uid' data-filter='#filter-$uid' $disablesort $page class='footable ssfa-sortable $theme $textalign $treeclass $bulkclass' $data_drawer $data_atts>".
			"<thead><tr>".
