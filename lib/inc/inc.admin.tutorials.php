	...
	'<div class="tutorials-select-wrap">'.
		...
		'<div class="fileaway-inline" id="fileaway-container-tutorials">'.
			'<select id="fileaway-tutorials" class="select chozed-select" data-placeholder="&nbsp;">'.
				...
				'<option value="add-links">Hyperlinks in Lists/Tables</option>'.
...
$output .= 
	'<div id="fileaway-tutorials-add-links" class="fileaway-tutorials" style="display:none;">'.
		...
		'<ol>'.
			...
			'<li>Open up the csv file in Excel or any spreadsheet editor, and change the urls and their corresponding "file names" to anything you desire. You can have a thousand links if you\'d like.</li>'.
