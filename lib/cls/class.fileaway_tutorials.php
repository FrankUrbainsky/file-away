	...
	class fileaway_tutorials
	{
		...
		public function optioninfo()
		{
			...
			$optioninfo['metadata'] = array(
				...
				'info' => "You have two options for storing metadata for your files: 1) In Database, or 2) In Filename. See the info box for Custom Columns Name(s) (i.e., customdata) for more information. To enable Database storage, just add <code>metadata=\"database\"</code> to your File Away table shortcode. For Filename storage, just omit the <code>metadata</code> attribute, as it is the default behavior. Note, with either option, do not use commas ( , ) in your descriptions, as commas are used to separate multiple columns."
			);							
