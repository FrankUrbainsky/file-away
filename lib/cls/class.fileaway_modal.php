...
if(class_exists('fileaway_admin') && !class_exists('fileaway_modal'))
{
	class fileaway_modal extends fileaway_admin
	{
			...
			foreach($this->shortcodes as $shortcode => $array)
			{
				...
				foreach($array['types'] as $type)
				{
					...
					foreach($array as $key => $a)
					{
						...
						$section = $a['section'];
						$infolink = $key == 'style' ? null : '<span class="link-fileaway-help-'.$key.' fileaway-helplink fileaway-help-iconinfo2"></span>';
						if($a['element'] == 'text')
						{
						...
						{				
							...
							if(isset($ops) && is_array($ops))
							{
								...
								{
									$fields[$shortcode][$type][$section][$i] .= '<option value="'.esc_attr($value).'">'.$option.'</option>';
								}
							}
		...
		public function params()
		{
			...
			$fileaway['unicode']['section'] = 'config';
			$fileaway['unicode']['label'] = 'Unicode Support';
			$fileaway['unicode']['element'] = 'select';
			$fileaway['unicode']['class'] = 'fileaway-half';
			...
			$fileaway['role_override']['label'] = 'Role Access Override';
			...
			$fileaway['showto']['label'] = 'Show to Roles';
			$fileaway['showto']['element'] = 'multiselect';
			$fileaway['showto']['class'] = 'fileaway-first-inline';
			$fileaway['hidefrom']['section'] = 'filters';
			$fileaway['hidefrom']['label'] = 'Hide from Roles';
			$fileaway['hidefrom']['element'] = 'multiselect';
			$fileaway['hidefrom']['class'] = '';
			$fileaway['style']['section'] = 'styles';
			$fileaway['style']['label'] = 'Style';
			$fileaway['style']['element'] = 'select';
			$fileaway['style']['class'] = '';
			...
			$attachaway['showto']['label'] = 'Show to Roles';
			$attachaway['showto']['element'] = 'multiselect';
			$attachaway['showto']['class'] = 'fileaway-first-inline';
			$attachaway['hidefrom']['section'] = 'filters';
			$attachaway['hidefrom']['label'] = 'Hide from Roles';
			$attachaway['hidefrom']['element'] = 'multiselect';
			$attachaway['hidefrom']['class'] = '';
			$attachaway['style']['section'] = 'styles';
			$attachaway['style']['label'] = 'Style';
			$attachaway['style']['element'] = 'select';
			$attachaway['style']['class'] = '';
			...
			$fileup['showto']['label'] = 'Show to Roles';
			$fileup['showto']['element'] = 'multiselect';
			$fileup['showto']['class'] = '';
			$fileup['hidefrom']['section'] = 'filters';
			$fileup['hidefrom']['label'] = 'Hide from Roles';
			$fileup['hidefrom']['element'] = 'multiselect';
			$fileup['hidefrom']['class'] = '';
			$fileup['style']['section'] = 'styles';
			$fileup['style']['label'] = 'Style';
			$fileup['style']['element'] = 'select';
			$fileup['style']['class'] = '';
