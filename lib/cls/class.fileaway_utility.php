	...
	class fileaway_utility
	{
		...
		public static function dynamicpaths($dir, $playbackpath = false)
		{
			...
			{ 
				...
				$feedback['dir'] = str_ireplace('fa-userrole', strtolower ($fa_userrole), $dir); 
			}
			if(stripos($dir, 'fa-username') !== false)
			{ 
				$feedback['private_content'] = true; 
				$feedback['fa_username_used'] = 1; 
				$feedback['dir'] = str_ireplace('fa-username', strtolower ($fa_username), $dir); 
			}
			if(stripos($dir, 'fa-firstlast') !== false)
			{ 
				$feedback['private_content'] = true; 
				$feedback['fa_firstlast_used'] = 1; 
				$feedback['dir'] = str_ireplace("fa-firstlast", strtolower ($fa_firstlast), $dir); 
			}
			if($playbackpath)
			{
				...
				{ 
					$feedback['private_content'] = true; 
					$feedback['fa_userrole_used'] = 1; 
					$feedback['playbackpath'] = str_ireplace('fa-userrole', strtolower ($fa_userrole), $playbackpath); 
				}
				if(stripos($playbackpath, 'fa-username') !== false)
				{ 
					$feedback['private_content'] = true; 
					$feedback['fa_username_used'] = 1; 
					$feedback['playbackpath'] = str_ireplace('fa-username', strtolower ($fa_username), $playbackpath); 
				}
				if(stripos($playbackpath, 'fa-firstlast') !== false)
				{ 
					$feedback['private_content'] = true; 
					$feedback['fa_firstlast_used'] = 1; 
					$feedback['playbackpath'] = str_ireplace("fa-firstlast", strtolower ($fa_firstlast), $playbackpath); 
				}
			}
			return $feedback;
		}
