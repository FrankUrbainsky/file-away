				...
				(
					...
					{ 
						...
						else
						{
							...
							$('td#folder-'+sfx).data('value', "0 0 0 0 0 "+response.newname).attr('data-value', "0 0 0 0 0 "+response.newname);
							$('td#name-'+sfx).data('value', "0 0 0 0 0 "+response.newname).attr('data-value', "0 0 0 0 0 "+response.newname);
