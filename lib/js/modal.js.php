...
jQuery(document).ready(function($)
{
	...
	{
		if($(this).val() != '') $flist_boxtheme_container.fadeIn(500);
		else 
		{
	...
	{
		if($(this).val() != '') $ftable_boxtheme_container.fadeIn(500);
		else 
		{
	...
	{
		if($(this).val() != '') $alist_boxtheme_container.fadeIn(500);
		else 
		{
	...
	{
		if($(this).val() != '') $atable_boxtheme_container.fadeIn(500);
		else 
		{
