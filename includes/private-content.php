...
if (stripos ($dir, 'fa-userid')){
	$private_content = true; $fa_userid_used = 1;
...
if (stripos ($dir, 'fa-userrole')){ 
	$private_content = true; $fa_userrole_used = 1;
...
if (stripos ($dir, 'fa-username')){ 
	$private_content = true; $fa_username_used = 1;
...
if (stripos ($dir, 'fa-firstlast')){ 
	$private_content = true; $fa_firstlast_used = 1;
